...
const GATES: GateStep[] = [
  ...
  },
  {
    ...
    command: 'npx',
    args: ['tsx', 'validators/validate-shot-spec.ts', 'connection-film/src/legacy/scopus-explainer/shot-spec.json'],
  },
  {
  ...
  },
  {
    ...
    args: [
      ...
      'connection-film/src/legacy/crispr',
      'connection-film/src/legacy/steam-engine',
      'connection-film/src/legacy/git-dag',
    ],
  },
  {
    ...
    args: [
      ...
      'connection-film/src/legacy/scopus-explainer/scenes',
      'connection-film/src/legacy/crispr/scenes',
      'connection-film/src/legacy/steam-engine/scenes',
      'connection-film/src/legacy/git-dag/scenes',
    ],
  },
  {

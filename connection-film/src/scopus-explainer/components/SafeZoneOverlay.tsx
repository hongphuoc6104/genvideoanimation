  ...
  return (
    ...
    >
      <svg width={TIKTOK_SAFE_ZONES.WIDTH} height={TIKTOK_SAFE_ZONES.HEIGHT} viewBox="0 0 1080 1920" fill="none">
        <g data-role="metadata" aria-hidden="true" data-part="safe-zone-overlay" data-joint="overlay-root">
        {/* Top Exclusion Zone */}
        <rect x={0} y={0} width={1080} height={SAFE_ZONE.TOP_MARGIN} fill="rgba(239, 68, 68, 0.15)" stroke="#EF4444" strokeWidth={2} />
        <text data-role="metadata" x={540} y={80} fill="#EF4444" fontSize={30} fontWeight="bold" textAnchor="middle">
        ...
        <text data-role="metadata" x={540} y={1800} fill="#EF4444" fontSize={30} fontWeight="bold" textAnchor="middle">
        ...
        <text data-role="metadata" x={970} y={960} fill="#F59E0B" fontSize={30} fontWeight="bold" textAnchor="middle" transform="rotate(90, 970, 960)">
        ...
        <rect
          ...
          strokeWidth={2}
        />
        <text data-role="metadata" x={540} y={1550} fill={PALETTE.EMERALD_LIGHT} fontSize={30} fontWeight="bold" textAnchor="middle">
